...
const ProductDetails = () => {
    ...
    useEffect(()=>{
        ...
        productsCopy = products.filter((item)=>item.category === product.category)
           ...
           <p>
            ...
            <div className="flex flex-col items-center mt-20">
                <div className="flex flex-col items-center w-max">
                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-12 lg:grid-cols-5 mt-6 w-full">
